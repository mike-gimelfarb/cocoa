...
#ifndef MULTIVARIATE_DIRECT_PRAXIS_H_
#define MULTIVARIATE_DIRECT_PRAXIS_H_
...
private:
	int praxis(int n, double *x, multivariate f);

	double flin(int n, int jsearch, double l, multivariate f, double *x,
	...
	void minny(int n, int jsearch, int nits, double &d2, double &x1, double &f1,
			bool fk, multivariate f, double *x, double t, double h, double *v,
			double *q0, double *q1, int &nl, int &nf, double dmin, double ldt,
			double &fx, double &qa, double &qb, double &qc, double &qd0,
			double &qd1);

	void quad(int n, multivariate f, double *x, double t, double h, double *v,
			double *q0, double *q1, int &nl, int &nf, double dmin, double ldt,
			double &fx, double &qf1, double &qa, double &qb, double &qc,
...
#endif /* MULTIVARIATE_DIRECT_PRAXIS_H_ */
