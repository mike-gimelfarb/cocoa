...
template<typename T> BrentSearch<T>::BrentSearch(double rtol, double atol,
		int mfev) {
	_mfev = mfev;
	_rtol = rtol;
	_atol = atol;
...
template<typename T> solution<T> BrentSearch<T>::optimize(univariate<T> f, T a,
		T b) {
	bool converged = false;
	int status = 0, fev = 0;
	T aa = a, bb = b, arg = (a + b) / 2, value = f(arg), c { }, d { }, e { },
			fu { }, fv { }, fw { }, fx { }, midpoint { }, p { }, q { }, r { },
			tol1 { }, tol2 { }, u { }, v { }, w { }, x { };
